...
export var data = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'data', 'api.json')));
var keys = Object.keys(data);

export var config_api = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'data', 'config-api.json')));
